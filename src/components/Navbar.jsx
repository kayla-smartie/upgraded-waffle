  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
      <div className='container mx-auto flex justify-between
       ...
       bg-transparent'>
        <img src={assets.logo} className='w-1/6 h-auto'alt="" />
        <ul className='hidden md:flex gap-7 text-white'>
            ...
            hover:text-gray-400'>Resources</a>
            <a href="#Discover" className='cursor-pointer
            hover:text-gray-400'>Discover</a>
        </ul>
        <button className='hidden md:block bg-white px-8 py-2
        rounded-full'><a href="#WasteForm">Get started</a></button>
      ...
      overflow-hidden bg-white transition-all`}>
        ...
        font-medium'>
            ...
            <a onClick={()=> setShowMobileMenu(false)} href="#Resources" className='px-4 py-2 rounded-full 
            inline-block'>Resources</a>
            <a onClick={()=> setShowMobileMenu(false)} href="#SignUp" className='px-4 py-2 rounded-full 
            inline-block'>Sign Up</a>
        </ul>
      </div>
    </div>
  )
